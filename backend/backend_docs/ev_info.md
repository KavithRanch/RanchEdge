# Expected Value (EV)
EV is generally a method for decision-making under uncertainty. It basically answers the question of `"if I make this decision repeatedly, will it yield good value on average"`.
